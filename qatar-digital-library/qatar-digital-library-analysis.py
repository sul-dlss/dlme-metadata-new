...
class Record:
    ...
    def get_record_id(self):
        """Find an identifier for the record."""
        try:
            record_id = self.elem.find(mods_ns + "identifier").text
            return record_id
        except:
...
def calc_completeness(stats_averages):
    ...
    dpla = [
        '{}titleInfo/{}title'.format(mods_ns, mods_ns),
        '{}identifier'.format(mods_ns),
        '{}accessCondition'.format(mods_ns)
    ]
